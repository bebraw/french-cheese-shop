...
- Primary output is `slides/output/teaching-proof-ai-re.pdf`.
...
- Treat `archive/teaching-proof-ai-re.pdf` as a release snapshot. Update it only when the user asks for the archival copy to be refreshed.
